...
public class Adapter_U_Orders extends RecyclerView.Adapter<Adapter_U_Orders.ItemViewHolder> {

    private final Context mContext;
    private final List<ModelOrder> orders;
    private OnItemClickListener mListener;

    public Adapter_U_Orders(Context mContext, List<ModelOrder> orders) {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.list_item_u_order, parent, false);
