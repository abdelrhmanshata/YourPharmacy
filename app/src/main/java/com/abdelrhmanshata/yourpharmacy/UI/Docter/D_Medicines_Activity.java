...
import com.abdelrhmanshata.yourpharmacy.databinding.ActivityDMedicinesBinding;

import java.util.ArrayList;
import java.util.List;
import java.util.Objects;

public class D_Medicines_Activity extends AppCompatActivity
        implements SwipeRefreshLayout.OnRefreshListener {

    public static String NameSearch = "";
    ActivityDMedicinesBinding medicinesBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicinesBinding = ActivityDMedicinesBinding.inflate(getLayoutInflater());
        ...
        medicinesBinding.addNewMedicine.setOnClickListener(v ->
        {
            startActivity(new Intent(this, Add_Medicine_Activity.class));
    ...
    private void Initialize_variables() {
        ...
        medicinesBinding.MedicineGridView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(D_Medicines_Activity.this, ShowMedicineActivity.class);
