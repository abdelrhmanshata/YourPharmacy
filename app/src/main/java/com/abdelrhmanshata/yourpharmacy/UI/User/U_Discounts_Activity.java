...
import com.abdelrhmanshata.yourpharmacy.databinding.ActivityUDiscountsBinding;

import java.util.ArrayList;
import java.util.List;
import java.util.Objects;

public class U_Discounts_Activity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    public static String NameSearch = "";
    ActivityUDiscountsBinding discountsBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        discountsBinding = ActivityUDiscountsBinding.inflate(getLayoutInflater());
