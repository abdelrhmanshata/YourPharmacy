...
import com.abdelrhmanshata.yourpharmacy.databinding.ActivityUProfileBinding;
...
public class U_Profile_Activity extends AppCompatActivity {

    ActivityUProfileBinding profileBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileBinding = ActivityUProfileBinding.inflate(getLayoutInflater());
        setContentView(profileBinding.getRoot());

        // Permissions to open Camera
        ActivityCompat.requestPermissions(U_Profile_Activity.this,
    ...
    private void UpdataData(String... data) {
        ...
        Toasty.success(U_Profile_Activity.this, "" + getResources().getString(R.string.updatedSuccessfully), Toast.LENGTH_SHORT).show();
    }

    private void SelectImage() {
        CropImage.activity()
                .setGuidelines(CropImageView.Guidelines.ON)
                .start(U_Profile_Activity.this);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1) {
            if (grantResults.length > 0
                ...
                Toasty.normal(U_Profile_Activity.this, getResources().getString(R.string.permissionDenied), Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void uploadImage(Uri filePath) {
        if (filePath != null) {
            ...
            StorageReference ref = storageReference
                    .child(user.getUid() + "/UserImage.jpeg");
                        ...
                        ref.getDownloadUrl()
                                .addOnSuccessListener(uri -> {
                                    if (!reference.onDisconnect().cancel().isSuccessful()) {
                                        ...
                                        Toasty.success(U_Profile_Activity.this, getString(R.string.updatedSuccessfully), Toast.LENGTH_SHORT).show();
                                        reference
                                                .child(user.getUid())
                                                .child("userImageUri")
                                                .setValue(uri.toString());
                                    } else {
                                        Toasty.error(U_Profile_Activity.this, getString(R.string.Updatefailed), Toast.LENGTH_SHORT).show();
                                    }
                                });
